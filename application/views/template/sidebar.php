    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('sim/add') ?>" class="nav-link <?= $title == 'Buat SIM' ? 'active' : '' ?>">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('sim/index') ?>" class="nav-link <?= $title == 'Daftar Pembuat SIM' ? 'active' : '' ?>">
                        <i class="nav-icon far fas fa-cogs"></i>
                        <p>
                            Daftar Pembuat SIM
                        </p>
